...
def find_strawberry(image):
    ...
    min_red = np.array([28,58,35])
    max_red = np.array([152,167,134])
    #layer
    mask1 = cv2.inRange(image_blur_hsv, min_red, max_red)

    #birghtness of a color is hue
    # 170-180 hue
    min_red2 = np.array([20,55,50])
    max_red2 = np.array([160,170,180])
...
#%%
#read the image
image = cv2.imread(r"C:\Users\Varsha\AppData\Local\Programs\Python\Python37-32\Dataset\Test\34.png")
#detect it
result = find_strawberry(image)
#write the new image
cv2.imwrite(r"E:\varsha01.png", result)
